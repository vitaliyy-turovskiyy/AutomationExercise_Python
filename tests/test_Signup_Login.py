...
class TestSignup:
    ...
    def test_TestCase1_Register_User(self, test_setup):
        ...
        #self.signup.day_of_birth_choose_click()
        #self.signup.may_months_of_birth_click()
        #self.signup.years_of_birth_choose_click()
        self.signup.newsletter_checkbox_click()
        #self.signup.optin_checkbox()
        ...
        #self.signup.country_menu_choose()
    ...
    def test_TestCase4_Logout_User(self, page, test_setup):
        ...
        #self.signup.navigates_to_login_page()
